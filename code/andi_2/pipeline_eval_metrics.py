...
def test_save(device,addre,filep_valid_id,save_dir,exp=None,fov=None,model_cp=True,addre_stage2=None,addre_state=None,addre_cp=None,CP=None,filep_index=None, offset=0,state=None):
    ################################################################################################################################
...
state = None
# state = np.load('/data1/jiangy/andi_tcu/results/nSQ/preds_all.npy', allow_pickle=True)
# print(state.shape)
...
#         if track == 'track_1':
#             public_data_path = '/data3/fxc/AnDiChallenge/dataset/public_data_validation_v1/track_1/exp_{}/'.format(
#                 i)  # make sure the folder has this name or change it
#             if task == 'vip':
#                 # VIP
#                 convert_csv_data_path = 'convert_trajs_fov_{}.csv'.format(j)
...
# np.save('../../challenge_results/{}/{}_{}_preds_all.npy'.format( addre[-4:-1], track, task), save_predsall)
# np.save('../../challenge_results/{}/{}_{}_pad_all.npy'.format( addre[-4:-1], track, task), save_padsall)

device = torch.device("cuda:4" if torch.cuda.is_available() else "cpu")
# addre = '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-28_12-56-39_daR/'
# addre_list = ['/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-28_20-28-44_Oqo/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-29_09-13-52_M6d/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-29_09-57-21_XIF/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-29_12-44-17_FBM/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-29_23-28-07_nSQ/',]
# addre_list = [ ]
# addre_list = ['/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-30_21-21-32_KIT/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-07-01_18-48-24_eXU/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-07-01_23-58-41_UqC/', '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-30_12-55-36_9VA/']
# addre_list = ['/data1/jiangy/andi_tcu/code/andi_2/output/_2024-07-03_00-23-45_6Y3/', '/data1/jiangy/andi_tcu/code/andi_2/challenge_output/_2024-07-02_11-17-11_eFD/']
addre_list = ['/data1/jiangy/andi_tcu/code/andi_2/output/_2024-07-10_00-36-18_NEY/',]
valid_file_list = [
    '/data1/jiangy/andi_data/0529/test/merge_3e5_new.csv',
    '/data1/jiangy/andi_data/0629_merge/test/merge_sample.csv', 
       '/data1/jiangy/andi_data/0702_T20_199_no_confine/test/merge_sample.csv', '/data1/jiangy/andi_data/0702_T20_199/test/merge_sample.csv',
       '/data1/jiangy/andi_data/0702_T200_no_confine/test/merge_sample.csv', '/data1/jiangy/andi_data/0702_T200/test/merge_sample.csv',
    '/data1/jiangy/andi_data/0621_immobile_traps/test/merge_sample.csv'
    ]
for addre in addre_list:
    for valid_file in valid_file_list:
        ...
        addre_stage2 = None
        # valid_file = '/data1/jiangy/andi_data/0629_merge/test/merge_sample.csv'
        save_dir = addre
