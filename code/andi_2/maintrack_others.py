...
if __name__ == '__main__':
    ...
    # config['train_address'] = '/data1/jiangy/andi_data/0702_T200/train/merge_sample.csv'
    ...
    config['valid_address'] = '../../../../jiangy/andi_data/0529/test/merge_3e5_new.csv'
    ...
    # config['valid_address'] = '/data1/jiangy/andi_data/0621_merge/test/merge_sample.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0702_T200/test/merge_sample.csv'
    #config['ood_class'] = 0 #
