...
preds_all = np.load('../../challenge_results/7av/track_1_vip_preds_all.npy', allow_pickle=True)
pad_all = np.load('../../challenge_results/7av/track_1_vip_pad_all.npy', allow_pickle=True)
...
for exp in exp_range:
    ...
    for fov in fov_range:
        filep_index = '../../dataset/track_1/exp_{}/convert_trajs_fov_index_{}.csv'.format(exp, fov)
        ...
        save_dir = '../../challenge_results/track_1/exp_{}'.format(exp)
