...
from running1_pipeline import setup, pipeline_factory, validate, check_progress, NEG_METRICS 
...
if __name__ == '__main__':
    ...
    # 回归
    config['model'] = 'ModelFusion'#'ModelFusion_noconv'#'GatedLSTM'#
    ...
    #config['train_address'] = '../../data/train0_Nall_6000_T20_200_K-12_6.csv'
    #config['valid_address'] = '../../data/test0_Nall_6000_T20_200_K-12_6.csv'
    #config['train_address'] = '../../data/2d_train_set_5400_Tmin_50_Tmax200_Dmax3.csv'
    #config['valid_address'] = '../../data/2d_valid_set_600_Tmin_50_Tmax200_Dmax3.csv'
    #config['train_address'] = '../../data/2d_train_set_5000_Tmin_50_Tmax200_Dmax3_diff.csv'
    #config['valid_address'] = '../../data/2d_valid_set_500_Tmin_50_Tmax200_Dmax3_diff.csv'
    # config['train_address'] = '../../../andi_solver/datasets/andi_set/0529/train/merge_3e5_new.csv'
    # config['train_address'] = '../../../andi_solver/datasets/andi_set/0529/test/merge_3e5_new.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0529/train/merge_3e5_new.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0626_multi_state/train/merge_sample.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0624_multi_state/train/merge_sample.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0624_multi_state/train/train0_Nall_500000_T20_50_K-6_6.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0624_multi_state/train/train0_Nall_500000_T50_100_K-6_6.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0624_multi_state/train/train0_Nall_500000_T100_200_K-6_6.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0602/train/merge_sample.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0621_merge/train/merge_sample.csv'
    config['train_address'] = '/data1/jiangy/andi_data/0629_merge/train/merge_sample.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0702_T200_no_confine/train/merge_sample.csv'
    # config['train_address'] =  '/data1/jiangy/andi_data/0621_merge_part/train/merge_sample_part0.csv'
    # config['train_address'] = '/data1/jiangy/andi_data/0621_confinement/train/merge_sample.csv'
    #config['train_address'] = '../../../../jiangy/project/andi_challenge/andi_solver/datasets/andi_set/0529/test/test0_Nall_50000_T20_50_K-12_6.csv'

    #config['train_address'] = '../../../../jiangy/andi_data/0529/train/merge.csv'
    # config['train_address'] = '../../data/test0_Nall_15000_T20_200_K-12_6.csv'
    # config['train_address'] = '../../data/train0_Nall_15000_T20_200_K-12_6.csv'
    # config['valid_address'] = '../../data/train0_Nall_15000_T20_200_K-12_6.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0626_multi_state/test/merge_sample.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0624_multi_state/test/merge_sample.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0624_multi_state/test/test0_Nall_500000_T20_50_K-6_6.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0624_multi_state/test/test0_Nall_500000_T50_100_K-6_6.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0624_multi_state/test/test0_Nall_500000_T100_200_K-6_6.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0621_confinement/test/merge_sample.csv'
    config['valid_address'] = '/data1/jiangy/andi_data/0629_merge/test/merge_sample.csv'
    # config['valid_address'] = '/data1/jiangy/andi_data/0702_T200_no_confine/test/merge_sample.csv'
    #config['ood_class'] = 0 #
    ...
    # 训练集分块，每20epoch切换下一块，切换下一个dataloader
    ...
    # config['log'] = 'ln'
    #config['normalization_layer'] = 'LayerNorm'
    # config['load_model'] = '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-30_19-56-17_4IM/checkpoints/model_last_seg.pth'
    # config['resume'] = True
    # config['lr'] = 7.8125e-05
    ...
    config2['pred_cp'] = True
    config2['pred_state'] = True
    config2['only_state'] = False
    config2['dimension'] = 2 * 3 + 2
    # config2['load_model'] = '/data1/jiangy/andi_tcu/code/andi_2/output/_2024-06-30_19-56-17_4IM/checkpoints/model_stage2_last_seg.pth'
    model_stage2 = model_factory(config2, my_data)
    optimizer_stage2 = optim_class(model_stage2.parameters(), lr=config2['lr'], weight_decay=weight_decay)
    reduce_schedule_stage2 = optim.lr_scheduler.ReduceLROnPlateau(optimizer_stage2, mode='min', factor=0.5, patience=10,
                                                           verbose=True, threshold=1e-4, threshold_mode='rel',
                                                           cooldown=0, min_lr=1e-20, eps=1e-15)
    if config['load_model'] is not None:
        model_stage2, optimizer_stage2, start_epoch = utils.load_model(model_stage2, config2['load_model'], optimizer_stage2, config2['resume'],
                                                         config2['change_output'],
                                                         config2['lr'],
                                                         config2['lr_step'],
                                                         config2['lr_factor'])
    model_stage2 = torch.nn.DataParallel(model_stage2, device_ids=gpus, output_device=gpus[0])
    ...
    trainer = runner_class(model, train_loader, device, loss_module, optimizer,weight_mask=t_mask,l2_reg=output_reg,
                           print_interval=config['print_interval'], console=config['console'],model_data=my_data,config=config,model_stage2=model_stage2,optimizer_stage2=optimizer_stage2)
    val_evaluator = runner_class(model, val_loader, device, loss_module, weight_mask=v_mask,
                                 print_interval=config['print_interval'], console=config['console'],model_data=my_data,config=config,model_stage2=model_stage2)
    ...
    best_value2 = 1e16 if config['key_metric'] in NEG_METRICS else -1e16
    ...
    # Evaluate on validation before training
    aggr_metrics_val, best_metrics, best_value, best_value2 = validate(val_evaluator, tensorboard_writer, config, best_metrics,
                                                          best_value, best_value2, epoch=0)
    ...
    for epoch in tqdm(range(start_epoch + 1, config["epochs"] + 1), desc='Training Epoch', leave=False):
        ...
        if config['part_data'] and (epoch == start_epoch+1 or epoch % config['change_epoch'] == 0):
            ...
            val_file = os.path.join(config['test_folder'], 'merge_sample_part{}.csv'.format(data_idx))
            print("change dataloader ...", data_idx, train_file, val_file)
            del train_dataset, train_loader, train_indices
            gc.collect()
            trainer.change_dataloader(None, None) # 改变成val_loader，降低内存占用
            # train_dataset, train_loader,train_indices,t_mask =track_data(config, train_file)
            with open(os.path.join(config['train_folder'], 'dataset_part{}.pkl'.format(data_idx)), 'rb') as f:
            ...
            train_loader = DataLoader(dataset=train_dataset,
                                  ...
                                  pin_memory=True,
                                  collate_fn=lambda x: collate_fn(x, max_len=model.module.max_len))
            # with open(os.path.join(config['train_folder'], 'dataloader_part{}.pkl'.format(data_idx)), 'wb') as f:
            #     dill.dump(train_loader, f)
            t_mask = torch.load(os.path.join(config['train_folder'], 'weight_part{}.pkl'.format(data_idx)), map_location='cpu')
            train_indices = torch.load(os.path.join(config['train_folder'], 'indices_part{}.pkl'.format(data_idx)), map_location='cpu')
            trainer.change_dataloader(train_loader, t_mask.to(device))

            val_dataset, val_loader,val_indices,v_mask  = track_data(config, val_file)
            val_evaluator.change_dataloader(val_loader, v_mask.to(device))
        ...
        if (epoch == config["epochs"]) or (epoch == start_epoch + 1) or (epoch % config['val_interval'] == 0):
            aggr_metrics_val, best_metrics, best_value, best_value2 = validate(val_evaluator, tensorboard_writer, config,
                                                                  best_metrics, best_value, best_value2, epoch)
            metrics_names, metrics_values = zip(*aggr_metrics_val.items())
            metrics.append(list(metrics_values))  #

        if epoch % 20 == 0:
            utils.save_model(os.path.join(config['save_dir'], 'model_{}_seg.pth'.format(epoch)), epoch, model, optimizer)
            utils.save_model(os.path.join(config['save_dir'], 'model_stage2_{}_seg.pth'.format(epoch)), epoch, model_stage2, optimizer_stage2)

        utils.save_model(os.path.join(config['save_dir'], 'model_{}_seg.pth'.format(mark)), epoch, model, optimizer)
        utils.save_model(os.path.join(config['save_dir'], 'model_stage2_{}_seg.pth'.format(mark)), epoch, model_stage2, optimizer_stage2)
        ...
        reduce_schedule_stage2.step(aggr_metrics_train['loss2'])
        ...
        if config['key_metric'] == 'accuracy':
            ...
            metric_list3.append(aggr_metrics_val['loss2'])
            metric_list4.append(aggr_metrics_train['loss2'])
        ...
        with open(os.path.join(config['output_dir'], (config[
            ...
            if config['key_metric'] == 'loss':
                writer = csv.writer(f)
                writer.writerow(['val_loss', 'train_loss', 'val_loss2', 'train_loss2' 'reduce_lr'])
                ttt = zip(metric_list1, metric_list2, metric_list3, metric_list4, multi_loss_list)
